...
export const storeSlice = createSlice({
  ...
  initialState: {
    ...
    orders: [
      {
        orderId: 1,
        fullName: "Manuel Hinojosa",
        contactEmail: "mangud.hinojosa@gmail.com",
        contactPhone: "6472874494",
        shippingAddress: "369 Soraunre Avenue",
        shippingUnit: "301",
        shippingCountry: "Canada",
        shippingProviceState: "Ontario",
        shippingCity: "Toronto",
        shippingPostalCode: "M6R3C2",
        dateOfPurchase: "20250619",
        pieceId: 12334,
        pieceTitle: "Piece Title this",
        pieceCost: 200,
      },
      {
        orderId: 2,
